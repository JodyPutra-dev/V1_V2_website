    ...
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        try {
          ...
          // Final debug: log what's actually set to state
          console.log('[DASHBOARD-FINAL] Stats set to state:', stats);
          console.log('[DASHBOARD-FINAL] Latest parameters after processing:', stats.latest?.parameters);
        } catch (statsError) {
                    ...
                    {predictionStats.latest.parameters && (
                      <div className="table-responsive">
                        ...
                        {predictionStats.latest.parameters.gravity && !predictionStats.latest.parameters.specificGravity ? (
                          ...
                          <>
                          {/* DEBUG: {JSON.stringify(predictionStats.latest.parameters)} */}
                          <table className="table table-hover table-sm">
                            <tbody>
                              ...
                              <tr>
                                <th className="text-nowrap">Specific Gravity:</th>
                                <td>{predictionStats.latest.parameters?.specificGravity || predictionStats.latest.parameters?.specificgravity || 'N/A'}</td>
                              </tr>
                              <tr>
                                <th className="text-nowrap">Turbidity NTU:</th>
                                <td>{predictionStats.latest.parameters?.turbidityNTU || predictionStats.latest.parameters?.turbidityntu || 'N/A'}</td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td>{predictionStats.latest.parameters?.turbidityLevel || predictionStats.latest.parameters?.turbiditylevel || 'N/A'}</td>
                              </tr>
                              <tr>
                                <th className="text-nowrap">Warna Dasar:</th>
                                <td>{predictionStats.latest.parameters?.warnaDasar || predictionStats.latest.parameters?.warnadasar || 'N/A'}</td>
                              </tr>
                            </tbody>
                          </table>
                          </>
